		...
		<ul class="nav menu">
			<li class="active"><a href="index.php?url=admin-panel.php"><em class="fa fa-edit">&nbsp;</em> Ajouter un article</a></li>
			<li><a href="index.php?url=admin-edit.php"><em class="far fa-newspaper">&nbsp;</em> Articles</a></li>
			<li><a href="index.php?url=admin-com-signaler.php"><em class="fas fa-comments">&nbsp;</em> Commentaires Signaler</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
		   ...
		   <br />
								...
								<br />  
								<input type="submit" name="addArticle" class="btn btn-info" value="send" />  
						   </form>  
